...
For full instructions, see [Activating developer mode](https://developer.roku.com/en-ca/docs/developer-program/getting-started/developer-setup.md) (if the link does not work, try refreshing)
