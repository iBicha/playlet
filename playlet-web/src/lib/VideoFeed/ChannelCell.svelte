<script lang="ts">
  ...
  export let subCountText: string | undefined = undefined;
  export let videoCountText: string | undefined = undefined;
  export let authorSubTitle: string | undefined = undefined;
...
<button class="w-60 p-2" on:click={modal.show()}>
  <div class="card card-compact bg-base-100 shadow-xl border border-neutral">
    ...
    <div class="card-body">
      <h3 class="card-title text-base line-clamp-2 min-h-8">{author}</h3>
